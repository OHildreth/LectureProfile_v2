...
// Targets → Signing and Capabilities → Hardened Runtime → There is a small, grey "x" in the upper left corner of the Hardened Runtime settings (just below the dividing line).  Click "x" to remove all hardened runtime.
